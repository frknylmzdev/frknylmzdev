...
<div align="center">
  ...
  | Action | XP Gained | Special Ability |
  |--------|-----------|----------------|
  | ⭐ Star a repository | +10 XP | Unlock "Code Insight" |
  | 🍴 Fork a repository | +20 XP | Unlock "Project Clone" |
  | 📝 Create an issue | +15 XP | Unlock "Bug Hunter" |
  | 🔍 Review code | +25 XP | Unlock "Code Wizard" |
  | 🛠️ Submit a PR | +50 XP | Unlock "Master Builder" |
  
  **Current Level: 1**  
  **XP: 0/100**  
  **Class: Full Stack Developer**  
  **Special Items: Mechanical Keyboard (+5 Coding Speed)**
  
  *Star this repo to help me gain XP and level up!*
...
2. Add the snake.yml file with the configuration provided
3. Make sure to enable GitHub Actions in your repository settings
-->
